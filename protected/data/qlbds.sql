...
MySQL - 5.5.29-log : Database - bdbds
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bdbds` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
insert  into `tbl_migration`(`version`,`apply_time`) values ('m000000_000000_base',1374153842),('m110805_153437_installYiiUser',1374153854),('m110810_162301_userTimestampFix',1374153855);
...
insert  into `tbl_users`(`id`,`username`,`password`,`email`,`activkey`,`superuser`,`status`,`create_at`,`lastvisit_at`) values (1,'admin','e10adc3949ba59abbe56e057f20f883e','nhan@glandoresystems.com','9f9e76d3d9c401c7e880c0c78a1359df',1,1,'2013-07-18 20:24:14','2013-07-23 13:52:37');
